                        ...
                        <Switch />
                                <div className="row align-item-center">
                                        <div className="home-text">
                                            <p className={darkMode? 'p-dark' : 'p'}>Hello, I'm</p>
                                            <h1 className={darkMode? 'h1-dark' : 'h1'}>Nahuel Stratico</h1>
                                            <h2 className={darkMode? 'h2-dark' : 'h2'}>Frontend web developer</h2>
            
                                            <Link className={ darkMode ? 'btn dark' : 'btn'} to="/about">  
                                                   More about me                                        
                                            </Link>
                                            <Link className={ darkMode ? 'btn dark' : 'btn'} to="/portfolio">
                                                portfolio
                                            </Link>
                                        </div>
                                        <div className="home-img">
                                            <div className={ darkMode ? 'img-box-dark' : 'img-box'}>
